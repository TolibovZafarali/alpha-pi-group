      ...
      <Container>
        ...
        <Reveal className="mt-10 grid gap-px bg-black/12 md:grid-cols-2">
          {contactDetails.operators.map((operator) => (
            <div className="bg-white px-6 py-6 sm:px-7 sm:py-7" key={operator.email.href}>
              <p className="font-mono text-[10px] tracking-[0.3em] text-black/48 uppercase">
                {operator.name}
              </p>

              <div className="mt-5 grid gap-4">
                <a
                  className="group flex items-start gap-3 text-black transition-colors duration-200 hover:text-black/64"
                  href={operator.email.href}
                >
                  <Mail className="mt-1 h-4 w-4 text-black/58" />
                  <div>
                    <p className="font-mono text-[10px] tracking-[0.24em] text-black/42 uppercase">
                      {operator.email.label}
                    </p>
                    <p className="mt-2 text-base text-black sm:text-lg">
                ...
                >
                  <PhoneCall className="mt-1 h-4 w-4 text-black/58" />
                  <div>
                    <p className="font-mono text-[10px] tracking-[0.24em] text-black/42 uppercase">
